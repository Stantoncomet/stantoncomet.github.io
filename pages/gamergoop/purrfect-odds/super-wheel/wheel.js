...
async function spin() {
    ...
    let status = document.getElementById('fstatus');
        ...
        incrementBalance(current_login, Number(-150))
        snd_spin.load()
        snd_spin.play()
    ...
    function spinEnd() {
        ...
        switch (true) {
            ...
            case result == 17:
                ...
                incrementBalance(current_login, Number(-400));
                snd_fail.load()
                snd_fail.play()
                break;
            case result == 18:
            ...
            case result == 19:
                ...
                incrementBalance(current_login, Number(-1000));
                snd_superfail.load()
                snd_superfail.play()
                break;
            default: 
            ...
            case result == 23:
                ...
                incrementBalance(current_login, Number(current_balance));
                snd_strange.load()
                snd_strange.play()
                break;
            case result == 24:
